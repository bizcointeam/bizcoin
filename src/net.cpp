...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "bizcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"pool1.cryptofactory.in", "pool1.cryptofactory.in"},
    {"pool2.cryptofactory.in", "pool2.cryptofactory.in"},
    {"node1.cryptofactory.in", "node1.cryptofactory.in"},
    {"node2.cryptofactory.in", "node1.cryptofactory.in"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("bizcoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. bizcoin is probably already running."), addrBind.ToString().c_str());
        else
